...
export const roundsConfig: Round[] = [
    // preview
    {
        ...
        content: {
            title: {
                text: 'Привет! Вот для тебя небольшое видеопоздравление',
                isColoredText: true,
                asset: (
                    <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube.com/embed/8xxXnBYVZJA?si=MR85SAbhBb1W-aub"
    ...
    // puzzle
    {
        ...
        content: {
            ...
            imageUrl: 'https://assets.happybirthdaydianayasenko.com/config1/content/ponchik.jpg',
            winExplanation: {
                text: 'Ты справилась! 🎉',
                asset: getRandomFromArray(CORRECT_EXPLANATION_ASSETS),
            },
    ...
    // press button
    {
        ...
        content: {
            title: {
                ...
                isUpsideDown: true,
                asset: <img src="https://assets.happybirthdaydianayasenko.com/config1/content/ponchik.jpg" />,
            },
            difficulty: 'EASY',
            winExplanation: {
                text: 'Ты справилась! 🎉',
    ...
    // multiple choice, with asset
    {
        ...
        content: {
            ...
            options: [
                {
                    text: 'Знать тебя не хочу',
                    asset: <img src="https://assets.happybirthdaydianayasenko.com/config1/content/dubai.jpg" />,
                },
                { text: 'Я католик' },
                { text: 'Спасибо за веру в меня' },
                {
